...
const POSTHOG_STORAGE_KEY = '.posthog-capacitor.json'
const POSTHOG_STORAGE_VERSION = 'v1'

type PostHogStorageContents = { [key: string]: any }

export class PostHogCapacitorStorage {
...
export class PostHogCapacitorSyncMemoryStorage extends PostHogCapacitorStorage {
  constructor() {
